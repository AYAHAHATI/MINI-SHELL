...
void init_shell() {
    ...
    printf("          ========================================\n");
    printf("\033[0;34m            🛠️  BIENVENUE DANS MON SHELL !  \n");
    printf("\033[0;36m          ========================================\n");
    printf("\033[0;33m           Réalisé par     : AYA HAHTI\n");
...
int simple_shell_help(char **argv) {
    static char help_information[] =
        ...
        "Description \n"
        "Aya Hahati's Shell is a simple UNIX command interpreter that replicates functionalities of the simple shell (sh).\n"
